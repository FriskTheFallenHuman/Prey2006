...
idCVar r_skipVideo( "r_skipVideo", "0", CVAR_RENDERER | CVAR_BOOL, "skip video decoding" );
...
idCVar r_lightScale( "r_lightScale", "2", CVAR_ARCHIVE | CVAR_RENDERER | CVAR_FLOAT, "all light intensities are multiplied by this" );
