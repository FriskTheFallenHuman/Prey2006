...
==============
*/
static void Con_History_f( const idCmdArgs &args ) {
...
==============
*/
static void Con_ClearHistory_f( const idCmdArgs &args ) {
	consoleHistory.ClearHistory();
}

/*
==============
idConsoleHistory::Init
==============
*/
void idConsoleHistory::Init( void ) {
	cmdSystem->AddCommand( "history", Con_History_f, CMD_FL_SYSTEM, "Displays the console command history" );
	cmdSystem->AddCommand( "clearHistory", Con_ClearHistory_f, CMD_FL_SYSTEM, "Clears the console history" );
}

/*
==============
idConsoleHistory::Shutdown
==============
*/
void idConsoleHistory::Shutdown( void ) {
	cmdSystem->RemoveCommand( "history" );
	cmdSystem->RemoveCommand( "clearHistory" );
}
...
========================
*/
void idConsoleHistory::LoadHistoryFile( void ) {
	idLexer lex;
...
========================
*/
void idConsoleHistory::ClearHistory( void ) {
	upPoint	   = 0;
	downPoint  = 0;
	returnLine = 0;
	numHistory = 0;
