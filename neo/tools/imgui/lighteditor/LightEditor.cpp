...
#if 0 // DG: the engine doesn't have this
	// RB: Quake 1 light styles
...
#if 0 // the engine doesn't have Quake lightstyles
	if( styleNames.Num() == 0 )
	{
		LoadLightStyles();
	}
...
#if 0 // the engine doesn't have this
	  // RB: light styles
...
#if 0 // The engine has no Quake lightstyles
