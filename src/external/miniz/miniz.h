...
#define MINIZ_NO_STDIO // DG: don't need STDIO here, miniZ*IP* does the I/O, mini*Z* is just for deflate
...
#define MINIZ_NO_ARCHIVE_APIS // DG: don't need this either, using minizip for zips

/* Define MINIZ_NO_ARCHIVE_WRITING_APIS to disable all writing related ZIP archive API's. */
/*#define MINIZ_NO_ARCHIVE_WRITING_APIS */
#define MINIZ_NO_ARCHIVE_WRITING_APIS // DG: neither this
